        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div style="position: relative; left: 40px;">
                    ...
                    失效时间：<b>${user.expireTime==""?'永不过期':user.expireTime}</b><br><br>
...
<div class="modal fade" id="exitModal" role="dialog">
    <div class="modal-dialog" role="document" style="width: 30%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='settings/user/logout.do'">确定</button>
            </div>
        </div>
    </div>
</div>
        ...
        <ul>
            <li class="dropdown user-dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <!--模态窗口：实际上就是一个div标签，通过点击的方式打开
                    data-toggle="modal操作的是模态窗口
                    data-target="#exitModal 打开哪一个模态窗口-->
                </ul>
            </li>
        </ul>
    </div>
